  ...
  <Layout>
    ...
    <div class="flex flex-wrap py-20 my-10">
      ...
      <div class="py-20 w-1/2 text-right">
        ...
        <span class="pr-10">
          <a href="mailto:info@bluefinch.uk" class="bg-pink-500 text-white active:bg-pink-600 font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button">
            Get in touch
          </a>
        </span>
      </div>
